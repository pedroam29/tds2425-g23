...
public class Mensaje3 {
	...
	public Mensaje3 (String texto, LocalDateTime hora, String tlfEmisor, String tlfReceptor) {
		this.texto = texto;
        this.fechaHora = hora;
	...
	public Mensaje3 (int emoticono, LocalDateTime hora, String tlfEmisor, String tlfReceptor) {
	...
	public Mensaje3(String texto, int emoticono, LocalDateTime hora) {
		this.texto = texto;
		this.emoticono = emoticono;
		this.fechaHora = hora;
	}
...
//	}
	...
	{
		return fechaHora.toString() + " " + tlfEmisor + " " + tlfReceptor + " " +texto;
	}
